...
## Steps to run:
- Clone the project using the command "git clone https://github.com/telman03/Email-Sender.git"
...
- Make changes in the [views.py] file inside the send_mail() method to add your mail address and the recipients mail address accordingly.
- Make changes in the [settings.py] file with your gmail id and your gmail id's password. 
